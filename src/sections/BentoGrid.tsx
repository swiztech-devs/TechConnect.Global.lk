...
const WorkflowAnimation = () => (
  <div className="mt-8 w-full h-32 bg-white rounded-2xl border border-white/10 flex items-center justify-center relative overflow-hidden shadow-2xl">
    <div className="flex items-center gap-3 sm:gap-6 relative z-10">
      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#2B2E83] flex items-center justify-center shadow-lg">
        <Database className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
      </div>

      <div className="w-12 sm:w-20 h-[2px] bg-slate-100 relative overflow-hidden">
        <motion.div
          animate={{ x: [-50, 100] }}
          transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
          className="absolute top-0 left-0 w-10 h-full bg-[#4A89C8]"
        />
      </div>
      ...
      <motion.div 
        ...
        className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-[#4A89C8] flex items-center justify-center shadow-[0_0_25px_rgba(74,137,200,0.4)]"
      >
      ...
      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center">
        <Cloud className="w-5 h-5 sm:w-6 sm:h-6 text-[#2B2E83]" />
      </div>
    </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tighter text-left">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4A89C8] to-white text-left">enemy of execution.</span>
          </h2>
        </motion.div>
        ...
        >
          <motion.div variants={itemVariants} className="md:col-span-1 group relative p-8 rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-xl hover:border-[#4A89C8]/30 transition-all duration-500 text-left">
            ...
            <p className="text-slate-400 font-light text-left text-sm">Centralize your ERP intelligence into a high-velocity source of truth.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="md:col-span-1 group relative p-8 rounded-[2.5rem] border border-[#2B2E83]/40 bg-[#2B2E83]/10 backdrop-blur-xl hover:border-[#4A89C8]/50 transition-all duration-500 shadow-[0_0_40px_rgba(43,46,131,0.1)] text-left">
            ...
            <p className="text-slate-300 font-light text-left text-sm">Edge-computing architectures for mission-critical industrial scale.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="md:col-span-1 group relative p-8 rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-xl hover:border-[#4A89C8]/30 transition-all duration-500 text-left">
            ...
            <p className="text-slate-400 font-light text-left text-sm">Military-grade protection for global cloud infrastructures.</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="md:col-span-2 group relative p-8 rounded-[2.5rem] border border-white/5 bg-white/[0.03] backdrop-blur-xl hover:border-[#4A89C8]/30 transition-all duration-500 overflow-hidden text-left">
             <div className="flex flex-col lg:flex-row gap-8 items-start text-left">
               <div className="flex-1 text-left">
                  ...
                  <p className="text-slate-400 font-light max-w-md text-left text-sm">
          ...
          <motion.div variants={itemVariants} className="md:col-span-1 group relative p-8 rounded-[2.5rem] border border-white/5 bg-white/[0.02] backdrop-blur-xl hover:border-[#4A89C8]/30 transition-all duration-500 text-left">
            ...
            <p className="text-slate-400 font-light text-left text-sm">Future-proof infrastructure that grows with your global ambition.</p>
